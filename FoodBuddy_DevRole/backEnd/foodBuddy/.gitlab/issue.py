...
headers = {
    "PRIVATE-TOKEN": "glpat-zp9ysr37mtq_gcvZ7shn"
}
for sf in smell_files:
    ...
    gitlab_output = requests.post(f"https://git.cs.dal.ca/api/v4/projects/{67450}/issues?{query_params}",headers=headers, data=body)
